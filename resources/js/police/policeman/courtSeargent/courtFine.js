...
//PAYMENT STATUS IS EXPIRED
    ...
    httpreq.send("action=viewFineAsCourtSeargent" + "&police_station=" + user_police_station + "&offence_type=" + offence_type);
    ...
    function completeLoad(httpreq)
    {
        ...
        else if(jsonFineData.serverResponse === "Allowed")
        {
            ...
            const fineData = document.getElementById("courtFineData");
            fineData.innerHTML = "";
            ...
            if(offence_type === "driver")
            {
                ...
                for(i=0; i<= count; i++)
                {
                    ...
                    dataCell3.innerHTML = jsonFineData.List[i].description;
                    ...
                    dataCell12.innerHTML = "<button type='button' id='viewLocationButton' onclick='viewLocation ("+latitude+", "+longitude+")'><i class='fa-solid fa-map-location-dot'></i></button>";
                    dataCell13.innerHTML = "<button type='button' id='viewFootageButton' onclick='viewFootage("+latitude+", "+longitude+")'><i class='fa-solid fa-photo-film'</i></button>";
                } 
            ...
            else if(offence_type === "pedestrian")
            {
                ...
                for(i=0; i <= count; i++)
                {
                    ...
                    dataCell11.innerHTML = "<button type='button' id='viewFootageButton' onclick='viewFootage("+latitude+", "+longitude+")'><i class='fa-solid fa-photo-film'</i></button>";
